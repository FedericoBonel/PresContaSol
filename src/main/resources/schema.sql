...
(
    ...
    `descripcion`    VARCHAR(2000) NOT NULL COLLATE 'utf8_general_ci',
...
(
    ...
    `convocatoria` VARCHAR(100) NOT NULL COLLATE 'utf8_general_ci',
...
(
    `identificador` VARCHAR(30) NOT NULL COLLATE 'utf8_general_ci',
    `nombre`        VARCHAR(30) NOT NULL COLLATE 'utf8_general_ci',
    `categoria`     INT(11)     NOT NULL,
    `supervisor`    VARCHAR(10) NULL DEFAULT NULL COLLATE 'utf8_general_ci',
    `representante` VARCHAR(10) NULL DEFAULT NULL COLLATE 'utf8_general_ci',
    PRIMARY KEY (`identificador`) USING BTREE,
...
CREATE TABLE `rol`
(
    `nombre` VARCHAR(20) NOT NULL COLLATE 'utf8_general_ci',
    PRIMARY KEY (`nombre`) USING BTREE
) COLLATE = 'utf8_general_ci'
  ENGINE = InnoDB
;
...
(
    `identificador` VARCHAR(10) NOT NULL COLLATE 'utf8_general_ci',
    `nombre`        VARCHAR(50) NOT NULL COLLATE 'utf8_general_ci',
    `clave`         VARCHAR(8)  NOT NULL COLLATE 'utf8_general_ci',
    `rol`           VARCHAR(50) NOT NULL COLLATE 'utf8_general_ci',
    PRIMARY KEY (`identificador`) USING BTREE,
